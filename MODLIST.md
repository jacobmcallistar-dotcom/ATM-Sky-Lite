# ATM Sky Lite - mod list

Generated from the live server's `mods/` folder. Jars themselves are
gitignored (they live in Releases), so this file is the only record in
version control of what the pack actually contains.

Regenerate with `tools-gen-modlist.py` after any mod change, so additions
and removals show up in the diff.
...
Legitimate client-side extras. Anything else appearing here is a sync bug -
a client with mods the server lacks is dropped at login with a mod channel
mismatch.
...
- `AdvancedAE-1.3.6-1.20.1.jar`
- `AdvancedPeripherals-1.20.1-0.7.48r.jar`
- `AetherVillages-1.20.1-1.0.7-forge.jar`
- `Apotheosis-1.20.1-7.4.8.jar`
- `ApothicAttributes-1.20.1-1.3.7.jar`
- `Applied-Mekanistics-1.4.3.jar`
- `AppliedFlux-1.20-1.3.7-forge.jar`
- `BOMD-Forge-1.20.1-1.1.2.jar`
- `BetterFusionReactor-1.20.1-1.4.15.jar`
...
- `ExtendedAE-1.20-1.4.12-forge.jar`
...
- `IntegratedCrafting-1.20.1-1.4.6.jar`
- `IntegratedDynamics-1.20.1-1.30.8.jar`
- `IntegratedTunnels-1.20.1-1.9.3.jar`
...
- `MoogsSoaringStructures-1.20-2.1.0.jar`
- `MoreMekanismProcessing-1.20.1-4.2.jar`
- `MouseTweaks-forge-mc1.20.1-2.25.1.jar`
- `MysticalAgradditions-1.20.1-7.0.12.jar`
- `MysticalAgriculture-1.20.1-7.0.24.jar`
- `PackagedAuto-1.20.1-3.4.15.46.jar`
- `Patchouli-1.20.1-85-FORGE.jar`
- `Placebo-1.20.1-8.6.3.jar`
- `Ponder-Forge-1.20.1-1.0.92.jar`
...
- `Super Factory Manager (SFM)-MC1.20.1-4.34.0.jar`
- `TerraBlender-forge-1.20.1-3.0.1.10.jar`
- `The_Undergarden-1.20.1-0.8.14.jar`
- `Toms-Performant-Storage-forge-0.1.0+1.20.1.jar`
...
- `aether-redux-2.0.19-1.20.1-neoforge.jar`
- `ancient_aether-0.9.10.jar`
...
- `createutilities-0.3.2+1.20.1.jar`
...
- `entangled-1.3.21-forge-mc1.20.4.jar`
- `entityculling-forge-1.10.5-mc1.20.1.jar`
- `exdeorum-1.53.jar`
- `exmachinis-deorum-1.20.1-3.1.0.jar`
- `extendedbonemeal-1.20.1-3.6.jar`
- `extrahnn-1.20.1-1.2.2.jar`
- `ferritecore-6.0.1-forge.jar`
- `flib-1.20.1-0.0.16.jar`
- `floating_islands-1.5.1.jar`
- `flywheel-forge-1.20.1-1.0.6-280.jar`
...
- `itemcollectors-1.1.12-forge-mc1.20.2.jar`
...
- `mcjtylib-1.20-8.0.8.jar`
- `megacells-forge-2.4.6-1.20.1.jar`
- `mekanism_extras-1.20.1-1.5.0.jar`
- `mekanism_ponders-1.0.3-1.20.1.jar`
- `mekanism_tfmg_compat-1.2-1.20.1.jar`
- `mekanism_turrets-1.3.2.jar`
- `mekmm-1.20.1-1.2.1.jar`
- `modernfix-forge-5.27.58+mc1.20.1.jar`
- `modonomicon-1.20.1-forge-1.79.3.jar`
- `modular-routers-12.1.1+mc1.20.1.jar`
- `moogs_structures-1.20-1.20.4-3.0.2-forge.jar`
- `moremekasuitunits-1.2-release-all.jar`
- `occultism-1.20.1-1.158.0.jar`
- `packetfixer-3.3.2-1.18-1.20.4-merged.jar`
- `pipe_connector-1.20.1-0.3.8.jar`
- `pipez-forge-1.20.1-1.2.26.jar`
- `pneumaticcraft-repressurized-6.0.23+mc1.20.1.jar`
- `powergrid-mc1.20.1-0.5.5.1.jar`
...
- `rftoolsbase-1.20-5.0.7.jar`
- `rftoolsbuilder-1.20-6.0.9.jar`
- `rftoolscontrol-1.20-7.0.4.jar`
- `rftoolsdim-1.20-11.0.11.jar`
- `rftoolspower-1.20-6.0.3.jar`
- `rftoolsstorage-1.20-5.0.4.jar`
- `rftoolsutility-1.20-6.0.7.jar`
- `rhino-forge-2001.2.3-build.10.jar`
- `shetiphiancore-forge-1.20.1-1.5.jar`
- `skyforge-1.20.1-0.18.0.jar`
- `sliceanddice-forge-3.6.0.jar`
- `sophisticatedbackpacks-1.20.1-3.24.59.1960.jar`
- `sophisticatedcore-1.20.1-1.3.66.2138.jar`
- `sophisticatedstorage-1.20.1-1.4.68.1961.jar`
...
- `titanium-1.20.1-3.8.35.jar`
- `toms_storage-1.20-1.7.1.jar`
- `waystones-forge-1.20.1-14.1.20.jar`
- `xaerominimap-forge-1.20.1-26.3.0.jar`
- `xaeroworldmap-forge-1.20.1-1.43.0.jar`
- `xnet-1.20-6.1.7.jar`
